        ...
        <div className="flex flex-col items-center min-h-screen bg-gray-100 p-8">
            <div className="mb-4">
                ...
                <div className={`text-lg mb-4 ${
                    gameResult ? 'text-green-600 font-bold' :
                    message.includes('Error') || message.includes('Invalid') ? 'text-red-500' :
                    'text-gray-700'
                }`}>
                    {message}
                </div>
                                ...
                                >
                                    ...
                                    {isPossible && (
                                        <div className={`
                                            ...
                                            ${piece === '.' ? 'bg-green-400 opacity-30 rounded-full w-4 h-4 mx-auto' : 'ring-2 ring-green-400'}
                                        `} />
                                    )}
                                </div>
                            );
